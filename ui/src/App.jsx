...
function SceneMap({scenes,active,focusRequest,onSelect,onPreview}){
...
export function App(){
 ...
 const selectCard=scene=>{setActive(scene);setMapFocus({id:scene.id,requestId:Date.now()})};
